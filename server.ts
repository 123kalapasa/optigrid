...
async function startServer() {
  ...
  app.post("/api/estimate", async (req: express.Request, res: express.Response) => {
    try {
      ...
      const prompt = `You are the chief technology officer and principal architect at 'Optigrid' (an elite tech agency based in Bangladesh offering hyper-optimized interfaces, automated workflow engines, and intelligent custom AI integrations for global clients).
...
Provide an intelligent, highly expert, and detailed technical architecture proposal and estimate. Highlight how our Bangladesh-based elite engineering team will deploy lightweight, hyper-fast systems to ensure competitive budgets while maintaining stellar international standard quality.`;
